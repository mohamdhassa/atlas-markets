...
def test_api_hardening_loads_before_phase_modules():
    ...
    assert html.index('/static/app.js') < html.index('phase48-api-hardening.js?v=48.0') < html.index('/static/phase7.js')
