...
def test_global_scope_and_scoped_operations_are_loaded():
    ...
    assert 'phase42-global-scope.js?v=42.0' in html
    assert 'phase43-scoped-operations.js?v=43.0' in html
    ...
    for page in ['Dashboard','Positions','Orders','Performance','Signals']:
        assert page in ops
