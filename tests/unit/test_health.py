...
def test_system_info_endpoint():
    r=client.get("/api/system");assert r.status_code==200;p=r.json();assert p["name"]=="ATLAS MARKETS";assert p["phase"]=="18";assert p["broker_accounts"]=="BYBIT+MT5+IBKR";assert p["live_execution"]=="GATED";assert p["automation"]=="ACTIVE";assert p["historical_learning"]=="ACTIVE";assert p["analytics"]=="STRATEGY+HISTORICAL_INTELLIGENCE"
