...
class BrokerProfile(Base):
    ...
    execution_certification_sell_passed: Mapped[bool] = mapped_column(Boolean, default=False)
    ...
    credential_blob_encrypted: Mapped[str | None] = mapped_column(Text, nullable=True)
