...
app=FastAPI(title=settings.app_name,version='0.33.0',debug=settings.debug,lifespan=lifespan)
...
async def system_info()->dict[str,str]:return {'name':settings.app_name,'status':'running','phase':'33','account_model':'EXTERNAL_PROVIDERS_ONLY','account_modes':'SIMULATION+LIVE_MONEY','broker_accounts':'BYBIT+MT5_FUSION+IBKR','market_data_providers':'BYBIT+MT5_FUSION+TWELVE_DATA+IBKR','live_money_execution':'GATED','provider_switching':'FRONTEND','automation':'CERTIFIED_ROUTES_ONLY','certified_automation':'MT5_DEMO','provider_certification':'IBKR_WHATIF+BYBIT_DIAGNOSTICS','analytics':'MULTI_MARKET+PER_ACCOUNT+PER_SYMBOL_STRATEGY','historical_learning':'ACTIVE','news_intelligence':'ACTIVE','reporting':'BROKER_NATIVE','market_scope':'FX+CRYPTO+STOCKS+ETFS+METALS+COMMODITIES','ibkr':'PAPER_WHATIF_PENDING_BRIDGE_PATCH','bybit_agent_connect':'TESTNET_DIAGNOSTICS'}
