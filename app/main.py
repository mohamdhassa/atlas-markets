...
app=FastAPI(title=settings.app_name,version="0.17.0",debug=settings.debug,lifespan=lifespan)
...
async def system_info()->dict[str,str]:return {"name":settings.app_name,"status":"running","phase":"17","market_data_provider":"BYBIT_CRYPTO+TWELVE_DATA_FX","paper_broker":"ATLAS_PAPER","broker_accounts":"BYBIT+MT5+IBKR","live_execution":"GATED","automation":"ACTIVE","analytics":"STRATEGY_INTELLIGENCE","news_intelligence":"ACTIVE","reporting":"ACTIVE","market_scope":"FX_CRYPTO_STOCKS_ETFS"}
