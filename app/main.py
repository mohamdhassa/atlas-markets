...
app=FastAPI(title=settings.app_name,version="0.10.0",debug=settings.debug,lifespan=lifespan)
...
async def system_info()->dict[str,str]:return {"name":settings.app_name,"status":"running","phase":"10","market_data_provider":"BYBIT","paper_broker":"ATLAS_PAPER","automation":"ACTIVE"}
