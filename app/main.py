...
app=FastAPI(title=settings.app_name,version="0.15.0",debug=settings.debug,lifespan=lifespan)
...
async def system_info()->dict[str,str]:return {"name":settings.app_name,"status":"running","phase":"15","market_data_provider":"BYBIT_CRYPTO","paper_broker":"ATLAS_PAPER","automation":"ACTIVE","analytics":"STRATEGY_INTELLIGENCE","news_intelligence":"ACTIVE","reporting":"ACTIVE","market_scope":"FX_CRYPTO_STOCKS_ETFS"}
