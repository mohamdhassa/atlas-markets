...
app=FastAPI(title=settings.app_name,version="0.19.0",debug=settings.debug,lifespan=lifespan)
...
async def system_info()->dict[str,str]:return {"name":settings.app_name,"status":"running","phase":"19","market_data_provider":"MULTI_PROVIDER_FOUNDATION","paper_broker":"ATLAS_PAPER","broker_accounts":"BYBIT+MT5+IBKR","live_execution":"GATED","automation":"ACTIVE","analytics":"ADAPTIVE_STRATEGY+HISTORICAL_INTELLIGENCE","historical_learning":"ACTIVE","news_intelligence":"ACTIVE","reporting":"ACTIVE","market_scope":"FX+CRYPTO+STOCKS+ETFS+METALS+COMMODITIES"}
